import asyncio, zmq, zmq.asyncio, sys, msgpack, logging, signal
import random, time
...
#
# A squad is a group of no more than 2 connectionsDESKFLOW_SCROLL_LINES=5 deskflow
